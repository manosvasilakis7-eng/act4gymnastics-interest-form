...
const SPORTS = [
  { key: "Ενόργανη Γυμναστική", desc: "Δύναμη, τεχνική και ισορροπία στα όργανα." },
  { key: "Ρυθμική Γυμναστική", desc: "Χάρη και έκφραση με όργανα χειρός." },
  { key: "Γυμναστική για Όλους", desc: "Άθληση και διασκέδαση χωρίς ανταγωνισμό." },
];
  ...
  return (
    <style>{`
      ...
      * { box-sizing: border-box; }
      ...
      .sport-title { font-weight: 700; font-size: 14.5px;
